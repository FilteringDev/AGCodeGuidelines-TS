...
| @typescript-eslint/consistent-type-imports | typescript/consistent-type-imports | native | `["error",{"fixStyle":"inline-type-imports"}]` | Javascript.md |
| @typescript-eslint/consistent-type-exports | typescript/consistent-type-exports | native | `["error",{"fixMixedExportsWithInlineTypeSpecifier":true}]` | Javascript.md |
| @typescript-eslint/explicit-function-return-type | typescript/explicit-function-return-type | native | `"error"` | Javascript.md |
| @typescript-eslint/explicit-member-accessibility | typescript/explicit-member-accessibility | native | `["error",{"accessibility":"explicit","overrides":{"accessors":"explicit","constructors":"no-public","methods":"explicit","properties":"off","parameterProperties":"explicit"}}]` | Javascript.md |
| @typescript-eslint/no-explicit-any | typescript/no-explicit-any | native | `"error"` | Javascript.md |
| @typescript-eslint/no-var-requires | typescript/no-var-requires | native | `"error"` | Javascript.md |
| @typescript-eslint/ban-ts-comment | typescript/ban-ts-comment | native | `"error"` | Javascript.md |
| @typescript-eslint/dot-notation | disabled | disabled | `"off"` | Javascript.md |
| @typescript-eslint/no-non-null-assertion | disabled | disabled | `"off"` | Javascript.md |
