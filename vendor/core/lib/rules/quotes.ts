/**
 * @file A rule to choose between single and double quote marks
 ...
 * @param this.quote The quote value.
 * @param str A string to convert.
 * @returns The string with changed quotes.
 */
function convert(this: { quote: string }, str: string) {
...
const rule: LegacyRule<
    [
        ...
        ('avoid-escape' | { avoidEscape?: boolean; allowTemplateLiterals?: boolean })?,
    ]
> = {
    meta: {
        deprecated: true,
    ...
    create(context) {
         ...
         *
         * - `<div className="foo"></div>` ... If the literal is an attribute value, the parent of the literal is
         * `JSXAttribute`.
         ...
         */
        function isAllowedAsNonBacktick(node: Node<'Literal'>) {
            const { parent } = node;
        ...
        /**
         * Checks whether or not a given TemplateLiteral node is actually using any of the special features provided
         * by template literal strings.
         * @param node A TemplateLiteral node to check.
         * @returns Whether or not the TemplateLiteral node is using any of the special features provided by
         * template literal strings.
         */
        function isUsingFeatureOfTemplateLiteral(node: Node<'TemplateLiteral'>) {
