/**
 * @file Rule to disallow if as the only statement in an else block
                    ...
                    context.report({
                        ...
                        fix(fixer: Fixer) {
                            ...
                            if (
                                ...
                                /**
                                 * If the `if` statement has no block, and is not followed by a semicolon, make sure
                                 * that fixing
                                 * the issue would not change semantics due to ASI. If this would happen, don't do a
                                 * fix.
                                 */
                                return null;
                            }
