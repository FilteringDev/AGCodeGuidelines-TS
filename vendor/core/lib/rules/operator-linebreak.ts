...
> = {
    ...
    create(context) {
         ...
         */
        function getFixer(operatorToken: Token, desiredStyle: string) {
            return (fixer: Fixer) => {
                ...
                if (hasLinebreakBefore !== hasLinebreakAfter && desiredStyle !== 'none') {
                    ...
                    /**
                     * If there is only one linebreak and it's on the wrong side of the operator, swap the text
                    ...
                    // Otherwise, if no linebreak is desired and no comments interfere, replace the linebreaks with
                    // empty strings.
                    newTextBefore = desiredStyle === 'before' || textBefore.trim()
                        ? textBefore
                        : textBefore.replace(LINEBREAK_REGEX, '');
                    newTextAfter = desiredStyle === 'after' || textAfter.trim()
                        ? textAfter
