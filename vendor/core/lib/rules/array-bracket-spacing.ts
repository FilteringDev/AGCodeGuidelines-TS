/**
 * @file Disallows or enforces spaces inside of array brackets.
...
const rule: LegacyRule<
    [
        ('always' | 'never')?,
        { singleValue?: boolean; objectsInArrays?: boolean; arraysInArrays?: boolean }?,
    ]
> = {
    meta: {
        deprecated: true,
    ...
    create(context) {
        ...
        function isOptionSet(
            option: keyof NonNullable<Parameters<typeof rule.create>[0]['options'][1]>,
        ) {
         ...
         */
        function isObjectType(node: Node) {
         ...
         */
        function isArrayType(node: Node) {
         ...
         */
        function validateArraySpacing(node: Node<'ArrayExpression' | 'ArrayPattern'>) {
