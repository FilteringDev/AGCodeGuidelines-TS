/**
 * @file Rule to enforce spacing around colons of switch statements.
...
const rule: LegacyRule<[{ before?: boolean; after?: boolean }?]> = {
    ...
    create(context) {
         ...
         */
        function fix(fixer: Fixer, left: Token, right: Token, spacing: boolean) {
            ...
            SwitchCase(node: Node<'SwitchCase'>) {
                ...
                if (!isValidSpacing(beforeToken!, colonToken!, beforeSpacing)) {
                    context.report({
                        ...
                        fix: (fixer: Fixer) => fix(fixer, beforeToken!, colonToken!, beforeSpacing),
                    });
                }
                if (!isValidSpacing(colonToken!, afterToken!, afterSpacing)) {
                    context.report({
                        ...
                        fix: (fixer: Fixer) => fix(fixer, colonToken!, afterToken!, afterSpacing),
                    });
                }
            },
        };
