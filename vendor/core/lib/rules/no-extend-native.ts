/**
 * @file Rule to flag adding properties to native object's prototypes.
 * @author David Nelson
 */
import * as dependency1 from 'globals';
...
const rule: LegacyRule<[{ exceptions?: string[] }?]> = {
    ...
    create(context) {
         ...
         */
        function reportNode(node: Node, builtin: string) {
            context.report({
                node,
         ...
         * false otherwise.
         */
        function isPrototypePropertyAccessed(identifierNode: Node<'Identifier'>) {
            return Boolean(
                identifierNode
         ...
         */
        function isAssigningToPropertyOf(node: Node) {
            return (
        ...
        /**
         * Checks if the given node is at the first argument of the method call of `Object.defineProperty()` or
         * `Object.defineProperties()`.
         * @param node The node to check.
         * @returns True if the node is at the first argument of the method call of `Object.defineProperty()` or
         * `Object.defineProperties()`.
         */
        function isInDefinePropertyCall(node: Node) {
            return (
         ...
         */
        function checkAndReportPrototypeExtension(identifierNode: Node<'Identifier'>) {
