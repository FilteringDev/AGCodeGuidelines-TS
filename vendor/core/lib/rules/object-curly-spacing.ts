/**
 * @file Disallows or enforces spaces inside of object literals.
...
const rule: LegacyRule<
    [('always' | 'never')?, { arraysInObjects?: boolean; objectsInObjects?: boolean }?]
> = {
    meta: {
        deprecated: true,
        replacedBy: [],
    ...
    create(context) {
         ...
         */
        function isOptionSet(option: 'arraysInObjects' | 'objectsInObjects') {
         ...
         * @returns '}' token.
         */
        function getClosingBraceOfObject(node: Node<'ObjectExpression' | 'ObjectPattern'>) {
         ...
         */
        function checkForObject(node: Node<'ObjectExpression' | 'ObjectPattern'>) {
         ...
         */
        function checkForImport(node: Node<'ImportDeclaration'>) {
         ...
         */
        function checkForExport(node: Node<'ExportNamedDeclaration'>) {
            if (node.specifiers.length === 0) {
                return;
            }
