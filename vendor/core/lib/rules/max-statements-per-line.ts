/**
 * @file Specify the maximum number of statements allowed per line.
...
const rule: LegacyRule<[{ max?: number }?]> = {
    ...
    create(context) {
        ...
        let firstExtraStatement: Node | null | undefined;
         ...
         */
        function getActualLastToken(node: Node) {
