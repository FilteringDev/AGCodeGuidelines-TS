    ...
    create(context) {
        ...
        return {
            Program() {
                ...
                comments
                    .filter((token: Token) => token.type === 'Line')
                    .forEach((node) => {
                        if (
                            applyDefaultIgnorePatterns
