...
/**
 * @file This rule should require or disallow spaces before or after unary operations.
...
const rule: LegacyRule<
    [{ words?: boolean; nonwords?: boolean; overrides?: { [key: string]: boolean } }?]
> = {
    meta: {
        deprecated: true,
        replacedBy: [],
