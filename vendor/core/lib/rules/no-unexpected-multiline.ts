/**
 * @file Rule to spot scenarios where a newline looks like it is ending a statement, but is not.
 * @author Glen Mailer
 */
...
const rule: LegacyRule<[]> = {
    ...
    create(context) {
         ...
         */
        function checkForBreakAfter(node: Node, messageId: string) {
        ...
        return {
            ...
            "BinaryExpression[operator='/'] > BinaryExpression[operator='/'].left":
                function onBinaryExpressionOperatorBinaryExpressionOperatorLeft(
