/**
 * @file Source code for spaced-comments rule
...
const legacyRule: LegacyRule<
    [
        ('always' | 'never')?,
        {
            exceptions?: string[];
            markers?: string[];
            line?: { exceptions?: string[]; markers?: string[] };
            block?: { exceptions?: string[]; markers?: string[]; balanced?: boolean };
        }?,
    ]
> = {
    meta: {
