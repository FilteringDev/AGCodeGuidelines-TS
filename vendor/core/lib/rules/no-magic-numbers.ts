/**
 * @file Rule to flag statements that use magic numbers (adapted from https://github.com/danielstjules/buddy.js)
 ...
 */
function normalizeIgnoreValue(x: bigint | number | string) {
    if (typeof x === 'string') {
...
> = {
    ...
    create(context) {
         ...
         */
        function isIgnoredValue(value: bigint | number) {
         ...
         */
        function isDefaultValue(fullNumberNode: Node<'Literal' | 'UnaryExpression'>) {
         ...
         */
        function isClassFieldInitialValue(fullNumberNode: Node<'Literal' | 'UnaryExpression'>) {
            const { parent } = fullNumberNode;
         ...
         */
        function isParseIntRadix(fullNumberNode: Node<'Literal' | 'UnaryExpression'>) {
            const { parent } = fullNumberNode;
         ...
         */
        function isJSXNumber(fullNumberNode: Node<'Literal' | 'UnaryExpression'>) {
        ...
        function isArrayIndex(
            fullNumberNode: Node<'Literal' | 'UnaryExpression'>,
            value: bigint | number,
        ) {
            const { parent } = fullNumberNode;
