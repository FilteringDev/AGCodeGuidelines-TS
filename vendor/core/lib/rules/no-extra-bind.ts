/**
 * @file Rule to flag unnecessary bind calls
...
const rule: LegacyRule<[]> = {
    ...
    create(context) {
         ...
         */
        function isSideEffectFree(node: Node) {
        ...
        function report(
            ...
            // The bind-call guard established this parent chain.
            const memberNode = node.parent as Node<'MemberExpression'>;
            const callNode = (
                memberNode.parent.type === 'ChainExpression'
                    ? memberNode.parent.parent
                    : memberNode.parent
            ) as Node<'CallExpression'>;
            ...
            context.report({
                ...
                fix(fixer: Fixer) {
                     ...
                     * This is two parts because closing parentheses may exist between the method name and
                     * arguments.
         ...
         */
        function enterFunction(node: Node<'FunctionDeclaration' | 'FunctionExpression'>) {
            scopeInfo = {
         ...
         */
        function exitFunction(node: Node<'FunctionDeclaration' | 'FunctionExpression'>) {
         ...
         */
        function exitArrowFunction(node: Node<'ArrowFunctionExpression'>) {
