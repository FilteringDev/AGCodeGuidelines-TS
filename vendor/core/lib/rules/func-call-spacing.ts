/**
 * @file Rule to control spacing within function calls
...
const rule: LegacyRule<['never'?] | ['always'?, { allowNewlines?: boolean }?]> = {
    meta: {
        deprecated: true,
        replacedBy: [],
        type: 'layout',
    ...
    create(context) {
         ...
         * @param leftToken The last token of the callee. This may be the closing parenthesis that encloses the
         * callee.
         * @param rightToken Tha first token of the arguments. this is the opening parenthesis that encloses the
         * arguments.
         */
        function checkSpacing(
            node: Node<'CallExpression' | 'ImportExpression' | 'NewExpression'>,
            leftToken: Token,
            rightToken: Token,
        ) {
