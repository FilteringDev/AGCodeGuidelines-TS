...
> = {
    ...
    create(context) {
         ...
         */
        function getNumberOfLinesBetween(
            left: Node<'ImportDeclaration'>,
            right: Node<'ImportDeclaration'>,
        ) {
            ...
            ImportDeclaration(node: Node<'ImportDeclaration'>) {
                if (!ignoreDeclarationSort) {
                    ...
                    if (previousDeclaration) {
                        ...
                        if (ignoreCase) {
                            previousLocalMemberName = previousLocalMemberName
                         ...
                         * Otherwise, make a default string compare (like rule sort-vars to be consistent) of the
                         * first used local member name.
                         */
