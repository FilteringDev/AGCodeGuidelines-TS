/**
 * @file Disallows or enforces spaces inside of parentheses.
...
> = {
    ...
    create(context) {
        ...
        return {
            Program: function checkParenSpaces(node: Node<'Program'>) {
                exceptions = getExceptions();
                const tokens = sourceCode.tokensAndComments;

                tokens.forEach((token: Token, i) => {
