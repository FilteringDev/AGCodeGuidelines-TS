/**
 * @file Rule to enforce placing object properties on separate lines.
...
const rule: LegacyRule<
    [{ allowAllPropertiesOnSameLine?: boolean; allowMultiplePropertiesPerLine?: boolean }?]
> = {
    meta: {
        deprecated: true,
        replacedBy: [],
                    ...
                    if (
                        ...
                        context.report({
                            ...
                            fix(fixer: Fixer) {
                                ...
                                // Don't perform a fix if there are any comments between the comma and the next
                                // property.
                                if (
                                    sourceCode.text
