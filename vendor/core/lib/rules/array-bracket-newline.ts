/**
 * @file Rule to enforce linebreaks after open and before close array brackets
...
> = {
    ...
    create(context) {
         ...
         */
        function normalizeOptionValue(option: Parameters<typeof rule.create>[0]['options'][0]) {
