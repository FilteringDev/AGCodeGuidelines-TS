...
const closureTags: AliasedTags = {
    ...
    // These are all recognized in
    // https://github.com/jsdoc/jsdoc/blob/master/packages/jsdoc/lib/jsdoc/tag/dictionary/definitions.js
