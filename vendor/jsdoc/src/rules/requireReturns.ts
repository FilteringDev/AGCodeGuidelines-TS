 ...
 * @returns *   true in case deep checking can be skipped; otherwise false.
 */
const canSkip = (utils: import('../iterateJsdoc').Utils): boolean => (
    utils.hasATag([
...
export default iterateJsdoc(
    ({
        ...
        const shouldReport = () => {
            ...
            if (publicOnly) {
                const opt: import('./requireJsdoc').RequireJsdocOpts = {
                    ancestorsOnly: Boolean((typeof publicOnly === 'object' ? publicOnly.ancestorsOnly : undefined) ?? false),
                    esm: Boolean((typeof publicOnly === 'object' ? publicOnly.esm : undefined) ?? true),
                    initModuleExports: Boolean((typeof publicOnly === 'object' ? publicOnly.cjs : undefined) ?? true),
                    initWindow: Boolean((typeof publicOnly === 'object' ? publicOnly.window : undefined) ?? false),
                };
